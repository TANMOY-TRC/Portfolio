...
const BanglaAlphabet = React.forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>(
  ({ stroke = "currentColor", strokeWidth = 2, ...props }, ref) => (
    <svg
      ref={ref}
...
BanglaAlphabet.displayName = "BanglaAlphabet";

export { BanglaAlphabet };
